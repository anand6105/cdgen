...
/* TaskPriorities. */
	...
	#define mainTask_ESSP4	( tskIDLE_PRIORITY + 1 +1 )
	#define mainTask_ESSP9	( tskIDLE_PRIORITY + 1 +2 )
	#define mainTask_ESSP5	( tskIDLE_PRIORITY + 1 +3 )
	#define mainTask_ESSP0	( tskIDLE_PRIORITY + 1 +4 )
	#define mainTask_ESSP1	( tskIDLE_PRIORITY + 1 +5 )
	#define mainTask_ESSP7	( tskIDLE_PRIORITY + 1 +6 )
	#define mainTask_ESSP2	( tskIDLE_PRIORITY + 1 +7 )
	#define mainTask_ESSP6	( tskIDLE_PRIORITY + 1 +8 )
	#define mainTask_ESSP8	( tskIDLE_PRIORITY + 1 +9 )
