...
int main(void) 
{
	...
	xTaskCreate(vTask_ESSP6 , "Task_ESSP6", configMINIMAL_STACK_SIZE, &vTask_ESSP6, mainTask_ESSP6, NULL);
	xTaskCreate(vTask_ESSP4 , "Task_ESSP4", configMINIMAL_STACK_SIZE, &vTask_ESSP4, mainTask_ESSP4, NULL);
	vTaskStartScheduler();
	return EXIT_SUCCESS;
}
