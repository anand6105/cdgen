...
#include "label0.h"
 ...
 //Shared label 
	...
	void cIN_Task_ESSP3()
	{
		...
		TriggeredCylinderNumber_Task_ESSP3	=	shared_label_8bit_read(3);
	}

	void cOUT_Task_ESSP3()
	{
		MAFRate	=	MAFRate_Task_ESSP3;
		shared_label_8bit_write(3,TriggeredCylinderNumber_Task_ESSP3 );
	}
 ...
 //Shared label 
	...
	void cIN_Task_ESSP8()
	{
		...
		TriggeredCylinderNumber_Task_ESSP8	=	shared_label_8bit_read(3);
	}

	void cOUT_Task_ESSP8()
	{
		shared_label_8bit_write(3,TriggeredCylinderNumber_Task_ESSP8 );
	}
 ...
 //Shared label 
	...
	void cIN_Task_ESSP5()
	{
		...
		BrakeForceFeedback_Task_ESSP5	=	shared_label_8bit_read(0);
	...
	void cOUT_Task_ESSP5()
	{
		...
		shared_label_8bit_write(0,BrakeForceFeedback_Task_ESSP5 );
 ...
 //Shared label 
	...
	void cOUT_Task_ESSP9()
	{
		...
		shared_label_8bit_write(1,VotedWheelSpeed_Task_ESSP9 );
	}
