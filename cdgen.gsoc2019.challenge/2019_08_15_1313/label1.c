...
#include "label1.h"
 ...
 //Shared label 
	...
	void cIN_Task_ESSP6()
	{
		...
		VotedWheelSpeed_Task_ESSP6	=	shared_label_8bit_read(1);
	...
	void cOUT_Task_ESSP6()
	{
		...
		shared_label_8bit_write(2,MonitoredVehicleState_Task_ESSP6 );
		shared_label_8bit_write(1,VotedWheelSpeed_Task_ESSP6 );
 ...
 //Shared label 
	...
	void cIN_Task_ESSP7()
	{
		...
		BrakeForceFeedback_Task_ESSP7	=	shared_label_8bit_read(0);
	}

	void cOUT_Task_ESSP7()
	{
		shared_label_8bit_write(0,BrakeForceFeedback_Task_ESSP7 );
	}
 ...
 //Shared label 
	...
	{
		shared_label_8bit_write(3,TriggeredCylinderNumber_Task_ESSP1 );
	}
