...
#include "label0.h"
 ...
 //Shared label 
	...
	void cIN_Task_ESSP1()
	{
		...
		DecelerationVoltage1_Task_ESSP1	=	shared_label_16bit_read(9);
	}

	void cOUT_Task_ESSP1()
	{
		shared_label_16bit_write(1,DecelerationVoltage2_Task_ESSP1 );
		shared_label_16bit_write(9,DecelerationVoltage1_Task_ESSP1 );
	}
 ...
 //Shared label 
	...
	void cIN_Task_ESSP0()
	{
		VehicleSpeedVoltage2_Task_ESSP0	=	shared_label_16bit_read(4);
		VehicleSpeedVoltage1_Task_ESSP0	=	shared_label_16bit_read(7);
	}

	void cOUT_Task_ESSP0()
	{
		shared_label_16bit_write(4,VehicleSpeedVoltage2_Task_ESSP0 );
		shared_label_16bit_write(7,VehicleSpeedVoltage1_Task_ESSP0 );
	}
