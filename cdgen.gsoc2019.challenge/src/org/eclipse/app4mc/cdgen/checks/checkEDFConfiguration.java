...
public class checkEDFConfiguration{
	public checkEDFConfiguration (Amalthea model, String srcPath, String headerPath, int configFlag) throws IOException {
		EDFConfiguration(model, srcPath, headerPath, configFlag);
	}

	public void EDFConfiguration(Amalthea model, String srcPath, String headerPath, int configFlag) {
		try {
