...
#include "label2.h"
 ...
 //Shared label 
	...
	void cIN_Task_ESSP6()
	{
		...
		DecelerationVoltage1_Task_ESSP6	=	shared_label_16bit_read(2);
		VotedWheelSpeed_Task_ESSP6	=	shared_label_8bit_read(3);
	...
	void cOUT_Task_ESSP6()
	{
		...
		shared_label_16bit_write(2,DecelerationVoltage1_Task_ESSP6 );
		shared_label_8bit_write(3,VotedWheelSpeed_Task_ESSP6 );
